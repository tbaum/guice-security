...
class GuiceSecurityFilter {
    ...
    @Inject
    public GuiceSecurityFilter(SecurityService securityService, RoleConverter roleConverter, UserService userService,
                               SecurityAudit audit) {
    ...
    @SecurityScoped
    void handleFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            try {
                authenticateToken(servletRequest.getHeader(SecurityFilter.HEADER_NAME), servletResponse);
    ...
    public void setSessionToken(String token) {
        ...
        currentResponse.get().setHeader(SecurityFilter.HEADER_NAME, token);
    }
